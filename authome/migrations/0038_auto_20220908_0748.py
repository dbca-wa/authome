# Generated by Django 3.2.12 on 2022-09-07 23:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_session_key', models.CharField(db_index=True, editable=False, max_length=128, null=True)),
                ('source_session_key', models.CharField(editable=False, max_length=128, null=True)),
                ('target_session_key', models.CharField(editable=False, max_length=128, null=True)),
                ...
                ('category', models.PositiveSmallIntegerField(choices=[(10, 'Create cookie'), (11, 'Update cookie'), (12, 'Delete cookie'), (20, 'Upgrade session'), (21, 'Upgrade upgraded session'), (22, 'Upgrade non-exist session'), (30, 'Migrate session'), (31, 'Migrate migrated session'), (32, 'Migrate non-exist session'), (40, 'Move previous session'), (41, 'Move moved previous session'), (42, 'Move non-exist previous session'), (123, 'Upgrade non-exist upgraded session'), (133, 'Migrate non-exist migrated session'), (143, 'Move non-exist moved previous session'), (201, 'LB key not match'), (202, 'Domain not match'), (200, 'Error')], default=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='authome.auth2cluster')),
            ],
            options={
