...
TRAFFIC_MONITOR_EXPIRE=env('TRAFFIC_MONITOR_EXPIRE',default=86400) #traffic monitor data expire time
TRAFFIC_MONITOR_INTERVAL=env('TRAFFIC_MONITOR_INTERVAL',default=300)
