...
SSO_CACHE_CHECKING_INTERVAL=env("SSO_CACHE_CHECKING_INTERVAL",default=300)
if SSO_CACHE_CHECKING_INTERVAL <= 0:
    SSO_CACHE_CHECKING_INTERVAL=300

AUTHORIZATION_CACHE_DELAY=env("AUTHORIZATION_CACHE_DELAY",default=300)
if AUTHORIZATION_CACHE_DELAY > 0:
    AUTHORIZATION_CACHE_DELAY = timedelta(days=AUTHORIZATION_CACHE_DELAY)
else:
    AUTHORIZATION_CACHE_DELAY = timedelta(days=300)

AUTH_CACHE_SIZE=env("AUTH_CACHE_SIZE",default=2000)
TOKEN_AUTH_CACHE_SIZE=env("TOKEN_AUTH_CACHE_SIZE",default=1000)
AUTHORIZATION_CACHE_SIZE=env("AUTHORIZATION_CACHE_SIZE",default=0)

TOKEN_AUTH_CACHE_EXPIRETIME=env('TOKEN_AUTH_CACHE_EXPIRETIME',default=3600) #user access token life time in seconds
if TOKEN_AUTH_CACHE_EXPIRETIME > 0:
    TOKEN_AUTH_CACHE_EXPIRETIME = timedelta(seconds=TOKEN_AUTH_CACHE_EXPIRETIME)
else:
    TOKEN_AUTH_CACHE_EXPIRETIME = None
