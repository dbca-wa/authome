...
LOAD_REDISCLUSTER_GROUPS_INTERVAL=env('LOAD_REDISCLUSTER_GROUPS_INTERVAL',default=60) #load redis cluster groups in seconds
if LOAD_REDISCLUSTER_GROUPS_INTERVAL > 0:
    LOAD_REDISCLUSTER_GROUPS_INTERVAL = timedelta(seconds=LOAD_REDISCLUSTER_GROUPS_INTERVAL)
else:
    LOAD_REDISCLUSTER_GROUPS_INTERVAL = timedelta(seconds=60)
